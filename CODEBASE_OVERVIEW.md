...
4. **Real-time Dashboard** - Shows categorized news feeds with AI summaries
5. **Crawler Health Monitor** - Tracks crawler performance and reliability
6. **Smart Caching** - Multi-layer caching for fast page loads
...
incidents/                 # Map incidents (max 10)
...
| `src/services/incident-service.ts` | Server | Incident CRUD |
...
| `src/ai/flows/extract-incidents-from-news-flow.ts` | Incident extraction |
