...
export const incidents: Incident[] = [
  { id: 1, title: 'Flood Warning', description: 'Heavy rainfall has led to severe flooding in the Afar region. Major rivers have overflowed their banks, displacing thousands of families and disrupting agricultural activities. Emergency response teams are on site.', latitude: 11.83, longitude: 41.0, color: '#3b82f6' }, // Afar Region
  { id: 2, title: 'Health Emergency', description: 'A significant health emergency has been declared in the Somali region due to a fast-spreading disease. Mobile clinics have been dispatched, but more medical supplies and personnel are urgently needed.', latitude: 6.5, longitude: 43.5, color: '#ef4444' }, // Somali Region
  { id: 3, title: 'Conflict Zone', description: 'Reports of localized conflict in the northern Tigray region have been confirmed. Humanitarian access is currently restricted, raising concerns for the safety and well-being of the civilian population.', latitude: 13.5, longitude: 39.5, color: '#f59e0b' }, // Tigray Region
  { id: 4, title: 'Displacement Camp', description: 'A new displacement camp has been established near the capital to shelter families fleeing from drought-affected areas. The camp is in need of clean water, food, and sanitation facilities.', latitude: 9.03, longitude: 38.74, color: '#22c55e' }, // Addis Ababa
];
